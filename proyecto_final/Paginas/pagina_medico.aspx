<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pagina_medico.aspx.cs" Inherits="proyecto_final.pagina_medico" %>
    ...
    <form id="form1" runat="server">
        <div class="main-content">
            ...
            <div class="page-header">
                <h2 class="fw-semibold">Panel Médico</h2>
                <p class="text-muted">Seleccione una opción para gestionar</p>
            </div>
